...
def derivatives(coordinates,prisms,field):
    """
    Computing the derivatives of a potential function generated by a
    rectangular prism.
    """
    ...
    jit_kernels(coordinates, prisms, kernels[field], result)
    return result

@jit(nopython=True)
def jit_kernels(coordinates,prisms,density,kernel,out):
    """
    Compute the derivatives at the observation points
    """
            ...
            for i in range(2,0,-1):
                for j in range(2,0,-1):
                    for k in range(2,0,-1):
                        ...
                        out[l] += ((-1) ** (i + j + k)* kernel(Y, X, Z))


@jit(nopython=True)
def kernel_potential(Y, X, Z):
    """
    Kernel function for potential field generated by a prism
    """
...
def kernel_z(Y, X, Z):
    """
    Kernel for the first derivative in relation to z of the potential generated
    by a prism
    """
    radius = np.sqrt(Y ** 2 + X ** 2 + Z ** 2)
...
def kernel_x(Y, X, Z):
    """
    Kernel for the first derivative in relation to x of the potential generated
    by a prism
    """
    radius = np.sqrt(Y ** 2 + X ** 2 + Z ** 2)
...
def kernel_y(Y, X, Z):
    """
    Kernel for the first derivative in relation to y of the potential generated
    by a prism
    """
    radius = np.sqrt(Y ** 2 + X ** 2 + Z ** 2)
